...
cfg.CASA.MATCH.NHEAD = 15
cfg.CASA.MATCH.D_MODEL = 75  # The maximum length of the sequences
...
cfg.CONSTRASTIVE.AUGMENTATION_STRATEGY = [
    'fast', 'noise_angle', 'flip', 'noise_translation', 'noise_vposer']
